...
"""Logic for extracting data from attendance pages."""
...
from nobrakes._api.typing import AttendancePgDataLabel, ETreeElement
...
async def fetch[K: AttendancePgDataLabel](
